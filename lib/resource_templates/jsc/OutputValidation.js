...
try {
    ...
    parameters.forEach(function(parameter){
        ...
        if("required" in parameter && !(parameter['name'] in context.proxyRequest.queryParams)) {
        ...
        if("pattern" in parameter && parameter[pattern] !== "") {
            ...
            try {
                ...
                var result = pattern.test(context.proxyRequest.queryParams[parameter.name].toLowerCase());
            } catch(e) {
                throw e;
            }
